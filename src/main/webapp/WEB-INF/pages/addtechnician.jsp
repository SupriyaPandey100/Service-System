...
<head>
    ...
    <title>Add Technician | HomeService</title>
...
<body>
    ...
    <div class="upload-card">
        ...
        <p class="subtitle">Fill in the details to add a service technician</p>
        ...
        <form action="addtechnician" method="post">
            <div class="input-group">
                ...
                <input type="text" name="full_name" value="${full_name}" placeholder="Enter full name">
            </div>
            ...
            <div class="row">
                ...
                <div class="input-group">
                    ...
                    <input type="tel" name="phone" value="${phone}" placeholder="10 digits">
                </div>
            </div>

            <div class="input-group">
                <label>Services <span class="required">*</span></label>
                <input type="text" name="services" value="${services}" placeholder="e.g., Plumbing, Electrical">
            </div>

            <div class="row">
                <div class="input-group">
                    <label>Completed Jobs</label>
                    <input type="number" name="completed_jobs" min="0" value="${completed_jobs != null ? completed_jobs : '0'}" placeholder="Jobs completed">
                </div>
                <div class="input-group">
                    <label>Status</label>
                    <select name="status">
