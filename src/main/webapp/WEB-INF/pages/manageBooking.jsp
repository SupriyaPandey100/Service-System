...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/manageBooking.css">
<style>
                ...
                <div class="booking-body">
                    ...
                    <div class="booking-actions">
                        ...
                        <c:if test="${booking.status == 'PENDING'}">
                            ...
                            <form action="${pageContext.request.contextPath}/admin/manageBooking"
                                  method="post"
                                  class="assign-form">
